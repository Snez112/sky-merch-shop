    ...
    const packs = [
        {
            ...
            oldPrice: `${Math.round(pricing.getPrice(30) * 1.1).toLocaleString('vi-VN')}đ`,
        ...
        },
        {
            ...
            oldPrice: `${Math.round(pricing.getPrice(100) * 1.17).toLocaleString('vi-VN')}đ`,
        ...
        },
        {
            ...
            oldPrice: `${Math.round(pricing.getPrice(170) * 1.26).toLocaleString('vi-VN')}đ`,
        ...
        },
        {
            ...
            oldPrice: `${Math.round(pricing.getPrice(360) * 1.3).toLocaleString('vi-VN')}đ`,
